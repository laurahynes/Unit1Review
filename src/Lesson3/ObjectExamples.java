...
public class ObjectExamples {
    ...
    public static void main(String[] args) {
        ...
        p1, 2, and 3 are still open to become different TYPE of PENS
        ...
        */
        ...
        All three pens respond to the SAME commands even though they are different
        p1. -> shows all of the Pens instance methods (abilities) 
        -> All 3 Pens INHERIT their abilites from the parent Pen Class
        ...
        -> Objects is the MOTHER OF ALL CLASSES
